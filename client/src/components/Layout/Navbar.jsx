...
const Navbar = () => {
    ...
    return (
        <nav className="bg-chefie-card md:bg-chefie-card/80 md:backdrop-blur-md shadow-sm border-b border-chefie-border sticky top-0 z-50 print:hidden">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <Link to={`/profile/${user.id}`} className="hover:opacity-80 transition-opacity">
                                    {user.profile_image ? (
                                        ...
                                        <div className="w-8 h-8 rounded-full bg-chefie-cream text-chefie-dark flex items-center justify-center font-bold text-xs border border-gray-100">
